    ...
    for (let z = -this.radius; z <= this.radius; z += step) {
      for (let y = -this.radius; y <= this.radius; y += step) {
        for (let x = -this.radius; x <= this.radius; x += step) {
          ...
          const xc = x + this.center.x;
          const yc = y + this.center.y;
          const zc = z + this.center.z;

          const p0 = [xc - hs, yc + hs, zc - hs];
          const p1 = [xc + hs, yc + hs, zc - hs];
          const p2 = [xc + hs, yc - hs, zc - hs];
          const p3 = [xc - hs, yc - hs, zc - hs];
          const p4 = [xc - hs, yc + hs, zc + hs];
          const p5 = [xc + hs, yc + hs, zc + hs];
          const p6 = [xc + hs, yc - hs, zc + hs];
          const p7 = [xc - hs, yc - hs, zc + hs];
          ...
          for (let i = 0; i < tri.length; i += 3) {
            ...
            const index0 = this.pushVertex(vert0, this._normal(equation, vert0));
            const index1 = this.pushVertex(vert1, this._normal(equation, vert1));
            const index2 = this.pushVertex(vert2, this._normal(equation, vert2));
            this.pushTriangle(index0, index1, index2);
          }
        }
      }
    }
